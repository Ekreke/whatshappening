...
type Server struct {
	...
	RankServer *Server_RankServer `protobuf:"bytes,3,opt,name=rankServer,proto3" json:"rankServer,omitempty"`
}
...
func (x *Server) GetRankServer() *Server_RankServer {
	if x != nil {
		return x.RankServer
	}
	return nil
...
type Server_RankServer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Baseurl     string `protobuf:"bytes,1,opt,name=baseurl,proto3" json:"baseurl,omitempty"`
	CacheEnable bool   `protobuf:"varint,2,opt,name=cacheEnable,proto3" json:"cacheEnable,omitempty"`
}

func (x *Server_RankServer) Reset() {
	*x = Server_RankServer{}
	if protoimpl.UnsafeEnabled {
...
func (x *Server_RankServer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_RankServer) ProtoMessage() {}

func (x *Server_RankServer) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_RankServer.ProtoReflect.Descriptor instead.
func (*Server_RankServer) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_RankServer) GetBaseurl() string {
	if x != nil {
		return x.Baseurl
	}
	return ""
...
func (x *Server_RankServer) GetCacheEnable() bool {
	if x != nil {
		return x.CacheEnable
	}
	return false
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xc1, 0x03, 0x0a,
	...
	0x63, 0x12, 0x3d, 0x0a, 0x0a, 0x72, 0x61, 0x6e, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x52, 0x61, 0x6e, 0x6b, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x52, 0x0a, 0x72, 0x61, 0x6e, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x48, 0x0a, 0x0a, 0x52, 0x61, 0x6e, 0x6b, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x61, 0x73, 0x65, 0x75, 0x72, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x62, 0x61, 0x73, 0x65, 0x75, 0x72, 0x6c, 0x12, 0x20,
	0x0a, 0x0b, 0x63, 0x61, 0x63, 0x68, 0x65, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0b, 0x63, 0x61, 0x63, 0x68, 0x65, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	...
	0x42, 0x23, 0x5a, 0x21, 0x77, 0x68, 0x61, 0x74, 0x73, 0x68, 0x61, 0x70, 0x70, 0x65, 0x6e, 0x69,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Server_RankServer)(nil),   // 5: kratos.api.Server.RankServer
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.rankServer:type_name -> kratos.api.Server.RankServer
...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Server_RankServer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
